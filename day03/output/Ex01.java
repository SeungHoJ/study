...
public class Ex01 {
	public static void main(String[] args) {
		...
		// System.out.printf(); : 괄호안에 서식과 값을 차례대로 전달 받아서 출력한다
		
		System.out.println("a" + "aa"); // 연산자는 값을 만들어내는 기호이기 때문에
		System.out.println("b");		// 괄호안에 계산이 먼저 징행되고
		...
		Date today = new Date();	// 실행하는 시점의 현재 날짜 및 시간이 저정된 객체
		...
		lyrics += "하나님이 보우하사 우리나라 만세\r\n";
		
		// + 연산자는 숫자간의 연산에서 숫자를 계산하고
		// 문자열이 양쪽중 한곳에 포함되면, 문자열을 베이스로 하여 글자를 이어붙이기 한다(append)
		// 산술 연산자는 복합대입연산자 형식으로 사용할 수 있기 때문에
		// lyrics에 처음 값을 지정한 후
		// 기존 값을 유지하면서 새로운 내용을 덧붙이기(append)할때 사용할 수 있따
		...
		System.out.println("1"+"2");	//12	양쪽이 문자열, 글자모양을 이어붙힌다
		
		// print와 prinln의 차이는 주로 반복문 내부에서 값을 연속으로 출력할 때 활용한다
