...
<style>
	...
	table.myboardList  tr > th:nth-child(1) {width: 5%}
	table.myboardList  tr > th:nth-child(2) {width: 50%}
	table.myboardList  tr > th:nth-child(3) {width: 10%}
	table.myboardList  tr > th:nth-child(4) {width: 10%}
	table.myboardList  tr > th:nth-child(5) {width: 10%}
	table.myboardList  tr > th:nth-child(6) {width: 15%}
...
<header>
	...
	<div class="user inner">
		...
		<c:if test="${not empty login }">
			<a href="${cpath }/mypage.jsp">${login.username }</a>님 환영합니다
		</c:if>
	</div>
	<div>
		<ul>
