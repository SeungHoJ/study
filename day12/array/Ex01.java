...
//		String str= "Hello";
		...
		// => 다음 3개의 데이터를 각 2배씩 곱한다음 화면에 출력해보세요
		int n1 = 3,n2 = 5, n3 = 8;
		
		// 같은 자료형의 여러 변수를연속된 메모리 공간에 배치하기 위해 사용하는문법
		// 여러 데이터를 연속된메모리 공간에 배치하고, 순번(index)로 구분하는 자료구조
		// 이때 index는 항상 0부터 시작한다
		// 배열에 들어간 변수의 개수에 따라서 배열의길이(length)가 정해진다
