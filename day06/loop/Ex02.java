...
public class Ex02 {
	public static void main(String[] args) {
		...
		char ch = 'A';				// 반복문은 일정한 조건에 의해 반복한다
		while(ch <= 'Z') {
		...
		// 반복되는 현상의 규칙을 파악한다면 휠씬 수월하게 작업을 진행할 수 있다
		int st = 31;
		int fee = 3500;
		...
		// 오전취업반의 수업시간은 9시 10시 11시 12시 반, 1시 반, 2시 반이다
		// while을 이용하여 출력해보자
		
		int n1 = 9, n2 = 0, n3 = 9, n4 = 50;
		while(n1 < 15) {		// 조건이 항상 참인 반복문, 무한반복
