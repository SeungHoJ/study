...
class Child4 extends Parent4{
	...
	// 기존 기능의 형식은 그대로 정의하고, 내용만 새로 작성하여 사용할 수 있다
	// 기존에 정의된 하무를 새롭게 재정의한다 라고 하여 override라고 한다
	// 메서드 오버라이딩은 오버로딩과 달리 반환형, 함수이름, 매개변수의 형태 및 개수가 모두 일치해야한다
