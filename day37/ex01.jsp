...
<h3>서버에서 특정 값을문자열로생성하여 클라이언트에 보관하는 형식의 데이터</h3>
<h3>문자열 형태로 저장해두면, 다음번 방문 시 서버가 값을 회수하여 활용할 수 있다</h3>
<h3>쿠키는 일정시간 지나면 자동으로 소멸하게 되어 있다</h3>
<h3>쿠키는 클라이언트가 저장하기 때문에, 브라우저마다 다른 내용을 저장한다</h3>
...
<fieldset>
	...
	<%
		// 클라이언트가 서버에 방문 시 가지고 있던 쿠기를 요청에 담아서 보낸다
		// 첫번째 방문이라면 cookies 배열의 값을 null일수도 있다
		Cookie[] cookies = request.getCookies();
	
		// 쿠키의 값을 항상 문자열 형태이다. 쿠키의 값을 저장할 변수를 미리 만들어둔다
		String value = "";
